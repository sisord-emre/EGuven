...
function setLayout() {
  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      script.src = '/AdminAssets/js/layout-horizontal.js'; // Load script for horizontal layout
      ...
      script.src = '/AdminAssets/js/layout-compact.js'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = '/AdminAssets/js/layout-tab.js'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
