...
{
    public class MenuViewOnlineComponent : ViewComponent
    {
        ...
        public MenuViewOnlineComponent(AppDbContext context, UserManager<AppUser> userManager, IService<AppUserRole> appUserRoleService, IService<AppRole> appRoleService)
        {
            _context = context;
